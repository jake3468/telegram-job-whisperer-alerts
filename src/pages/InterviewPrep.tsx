        ...
        (payload) => {
          ...
          if (payload.new.interview_questions) {
            ...
            deductCredits(
              1.5,
              'interview_prep',
              `Interview prep for ${payload.new.company_name} - ${payload.new.job_title}`
            );
          }
        }
      )
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-white border-gray-300 text-black placeholder-gray-500 min-h-32"
                  disabled={isGenerating}
                />
              </div>
                  ...
                  <CardHeader>
                    <CardTitle className="text-white flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => copyToClipboard(JSON.stringify(interviewData.questions, null, 2))}
                  ...
                  <CardHeader>
                    <CardTitle className="text-white flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => copyToClipboard(interviewData.strategic_questions?.join('\n') || '')}
                        className="text-gray-400 hover:text-white"
                      >
                        <Copy className="w-4 h-4" />
                      </Button>
