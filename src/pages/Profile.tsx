  ...
  return <Layout>
      ...
      {!isAuthReady ? <div className="flex items-center justify-center min-h-[400px]">
          ...
          <div className="space-y-4">
            ...
            <div className="mb-6">
              <p className="text-gray-200 font-inter text-base mb-4">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-sky-500 to-fuchsia-500 hover:from-sky-600 hover:to-fuchsia-600 text-white font-semibold font-inter mb-4"
              >
                Go to Resume Bot
              </Button>
            </div>
