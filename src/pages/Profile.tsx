        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-100 font-inter font-light">
              Add your <span className="italic text-yellow-200">current resume</span> and <span className="italic text-pastel-blue">bio details</span> on this page. Once you're done, go to the <span className="italic text-amber-200">'Create Job Alerts'</span> page to set up personalized job alerts.
            </p>
          </div>
