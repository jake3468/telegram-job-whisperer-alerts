        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex-1">
            ...
            <p className="text-gray-100 font-inter font-light text-left text-base">
              Complete the below 3 simple steps to get started with your job search. Add your <span className="italic text-green-300">resume</span> and <span className="italic text-pastel-blue">bio</span>, then set up personalized <span className="italic text-amber-200">job alerts</span>.
            </p>
          </div>
