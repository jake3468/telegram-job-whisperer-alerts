    ...
    <div className="min-h-screen bg-background text-foreground font-inter">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 pt-32">
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-gray dark:prose-invert prose-cyan max-w-none [&_h2]:text-gray-900 [&_h2]:dark:text-white [&_h3]:text-cyan-600 [&_h3]:dark:text-cyan-400 [&_p]:text-gray-700 [&_p]:dark:text-gray-300 [&_li]:text-gray-700 [&_li]:dark:text-gray-300 [&_strong]:text-gray-900 [&_strong]:dark:text-white [&_.bg-gray-900]:bg-white [&_.bg-gray-900]:dark:bg-gray-900 [&_.border-gray-800]:border-gray-200 [&_.border-gray-800]:dark:border-gray-800">
            <section className="mb-8">
              ...
              <div className="bg-gradient-to-r from-cyan-100/20 to-cyan-200/20 dark:from-cyan-900/50 dark:to-cyan-800/50 p-8 rounded-xl border border-cyan-500/30 shadow-2xl">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Email Support</h3>
                    <p className="text-cyan-600 dark:text-cyan-200">Our primary support channel</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <p className="text-gray-900 dark:text-white text-xl font-semibold">support@aspirely.ai</p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Support Categories</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-cyan-500/50 transition-colors">
                  <h3 className="text-xl font-semibold text-cyan-600 dark:text-cyan-400 mb-3">Technical Issues</h3>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-cyan-500/50 transition-colors">
                  <h3 className="text-xl font-semibold text-cyan-600 dark:text-cyan-400 mb-3">Account Management</h3>
                  <ul className="text-gray-700 dark:text-gray-300 space-y-2 text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-cyan-500/50 transition-colors">
                  <h3 className="text-xl font-semibold text-cyan-600 dark:text-cyan-400 mb-3">Feature Guidance</h3>
                  <ul className="text-gray-700 dark:text-gray-300 space-y-2 text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-cyan-500/50 transition-colors">
                  <h3 className="text-xl font-semibold text-cyan-600 dark:text-cyan-400 mb-3">Career Consultation</h3>
                  <ul className="text-gray-700 dark:text-gray-300 space-y-2 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Premium Support Benefits</h2>
              <div className="bg-gradient-to-r from-fuchsia-100/30 to-purple-100/30 dark:from-fuchsia-900/30 dark:to-purple-900/30 p-6 rounded-lg border border-fuchsia-500/30">
                <div className="flex items-center gap-3 mb-4">
                  <Shield className="w-6 h-6 text-fuchsia-600 dark:text-fuchsia-400" />
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white">For Paid Subscribers</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-fuchsia-600 dark:text-fuchsia-300 mb-2">Priority Response</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">Your support requests are prioritized and handled by our senior support specialists for faster resolution.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-fuchsia-600 dark:text-fuchsia-300 mb-2">Advanced Assistance</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">Access to detailed career guidance, personalized optimization tips, and advanced feature tutorials.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-fuchsia-600 dark:text-fuchsia-300 mb-2">Direct Access</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">Skip general support queues and get direct access to technical specialists familiar with premium features.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-fuchsia-600 dark:text-fuchsia-300 mb-2">Feature Previews</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">Early access to beta features and direct feedback channels for platform improvements.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">How do I maximize my AI-generated content quality?</h3>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">What should I do if my credits aren't working correctly?</h3>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">How do I set up Telegram integrations?</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Can I get refunds for unused credits or subscriptions?</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">How do I delete my account and data?</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Emergency Support</h2>
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/30 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-red-600 dark:text-red-400 mb-3">Urgent Issues</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Business Hours and Response Times</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-400 mb-3">Standard Support</h3>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                  <h3 className="text-lg font-semibold text-fuchsia-600 dark:text-fuchsia-400 mb-3">Premium Support</h3>
                  <div className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Support Best Practices</h2>
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-500/30 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-4">Help Us Help You</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">When Contacting Support:</h4>
                    <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 text-sm">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">For Faster Resolution:</h4>
                    <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Feedback and Suggestions</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-3">Share Your Ideas</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Our Commitment to You</h2>
              <div className="bg-gradient-to-r from-cyan-50 to-fuchsia-50 dark:from-cyan-900/30 dark:to-fuchsia-900/30 p-8 rounded-xl border border-cyan-500/30">
                <div className="flex items-center gap-3 mb-4">
                  <Users className="w-6 h-6 text-cyan-600 dark:text-cyan-400" />
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Dedicated Support Team</h3>
                </div>
                ...
                <div className="mt-6 p-4 bg-black/10 dark:bg-black/30 rounded-lg">
                  <p className="text-cyan-600 dark:text-cyan-200 font-medium text-center">
