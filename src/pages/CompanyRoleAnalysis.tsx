        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="bg-gradient-to-br from-green-500 via-green-600 to-green-700 border-green-400/30 shadow-2xl mx-auto max-w-3xl">
            <CardHeader className="bg-gradient-to-r from-green-600/90 via-green-700/90 to-green-800/90 border-b border-green-400/30">
              <CardTitle className="text-2xl font-orbitron text-white text-center">
                Company & Role Intelligence
              </CardTitle>
              <p className="text-green-100 text-center font-medium mt-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white border-green-300 text-black placeholder:text-gray-500 focus:border-green-500 focus:ring-green-500/20 h-12"
                      required
                    />
                  </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-green-700 via-green-800 to-green-900 hover:from-green-800 hover:via-green-900 hover:to-green-950 text-white font-orbitron font-bold py-6 text-lg shadow-2xl shadow-green-600/25 border-0"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={handleReset}
                    className="border-white/50 text-white hover:bg-white/20 hover:text-white font-orbitron bg-transparent"
                  >
