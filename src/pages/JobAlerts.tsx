  ...
  return <Layout>
      <div className="text-center mb-8">
        ...
        <p className="text-md text-orange-100 font-inter font-light mb-4">
          Get job alerts from the latest <span className="italic text-teal-200">24-hour</span> postings — sent to your <span className="italic text-pastel-peach">Telegram</span> and listed under 'Posted Today' in your <span className="italic text-pastel-peach">Job Board</span> page
        </p>
