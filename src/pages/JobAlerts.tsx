...
const JobAlerts = () => {
  ...
  return <Layout>
      <div className="text-center mb-8">
        ...
        backgroundClip: 'text',
        color: 'transparent'
      }} className="text-4xl font-orbitron font-extrabold bg-gradient-to-r from-orange-400 via-yellow-400 to-pink-500 bg-clip-text mb-2 drop-shadow tracking-tight text-amber-400">
