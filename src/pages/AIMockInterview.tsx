        ...
        <div className="container mx-auto px-4 py-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-6 relative">
              ...
              <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent text-left">AI Mock Interview</h1>
            ...
            <p className="text-gray-800 max-w-2xl mx-auto leading-relaxed text-left text-sm">Grace, your AI interview assistant from Aspirely AI, will call your phone in about a minute to ask real interview questions based on your job role — and you'll receive a detailed report right after the call.</p>
          </div>
