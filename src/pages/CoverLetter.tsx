                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <Textarea 
                          ...
                          required 
                          className="min-h-[60px] resize-none text-base bg-emerald-900/50 border-emerald-700/50 text-white placeholder:text-emerald-200/70" 
                        />
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <Textarea 
                          ...
                          required 
                          className="min-h-[200px] resize-none text-base bg-emerald-900/50 border-emerald-700/50 text-white placeholder:text-emerald-200/70" 
                        />
                      </div>
                      ...
                      <div className="flex gap-3 pt-4">
                        <Button 
                          ...
                          className="flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium text-base h-12"
                        >
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-3">
                          <Button 
                            ...
                            className="flex-1 bg-emerald-700 hover:bg-emerald-600 text-white flex items-center gap-2 text-base h-12"
                          >
