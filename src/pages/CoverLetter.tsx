...
const CoverLetter = () => {
  ...
  const loadingMessages = ["✍️ Crafting your personalized cover letter...", "📝 Tailoring content to match the job requirements...", "🎯 Highlighting your relevant skills and experience...", "✨ Finalizing your professional cover letter..."];
  useEffect(() => {
    if (isLoaded && !user) {
      navigate('/');
    }
    ...
    const pollForResults = async () => {
      try {
        const {
          data,
          error
        } = await supabase.from('job_analyses').select('cover_letter').eq('id', analysisId).single();
        if (error) {
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-4xl mx-auto px-3 py-8 sm:px-4 sm:py-12">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-purple-600 via-pink-600 to-rose-600 border-2 border-purple-400 shadow-2xl shadow-purple-500/20">
              ...
              <CardContent className="space-y-4 pt-0">
                ...
                <div className="space-y-3">
                  ...
                  {/* History Button */}
                  <JobAnalysisHistory type="cover_letter" gradientColors="bg-gradient-to-br from-purple-600 via-pink-600 to-rose-600" borderColors="border-2 border-purple-400" />

                  {(!isComplete || !isFormValid) && !isSubmitting && !isGenerating && <p className="text-purple-200 text-sm font-inter text-center">
            ...
            {isGenerating && <Card className="bg-gradient-to-br from-pink-600 via-rose-600 to-red-600 border-2 border-pink-400 shadow-2xl shadow-pink-500/20">
                <CardHeader className="pb-3">
            ...
            {coverLetterResult && <Card className="bg-gradient-to-br from-slate-800 via-slate-700 to-slate-600 border-2 border-slate-400 shadow-2xl shadow-slate-500/20 w-full">
                <CardHeader className="pb-3 bg-green-300">
                  <CardTitle className="font-inter flex items-center justify-between text-sm text-gray-950">
                    ...
                    <Button onClick={handleCopyCoverLetter} size="sm" className="bg-gray-950 hover:bg-gray-800 text-white border-gray-700 text-xs px-2 py-1">
                ...
                <CardContent className="pt-0 bg-green-300 p-4 w-full">
                  ...
                  <div className="bg-white rounded-lg shadow-lg border border-gray-200 w-full relative">
                    ...
                    <div className="p-6 bg-gradient-to-b from-white to-gray-50">
                      ...
                      <div className="text-slate-800 font-inter leading-relaxed font-medium w-full text-sm pl-4" style={{
                    wordWrap: 'break-word',
