...
const JobBoard = () => {
  const { jobs, loading, error } = useJobBoardData();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredJobs.map((job) => (
              <Card key={job.id} className="bg-black/40 backdrop-blur-sm border-gray-700 hover:border-purple-500/50 transition-all cursor-pointer">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {selectedJob.link_1_title && selectedJob.link_1_link && (
                        <Button
                          asChild
                          variant="outline"
                          className="justify-start border-purple-500/50 text-white hover:bg-purple-500/20"
                        >
