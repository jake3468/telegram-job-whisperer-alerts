        ...
        <div className="relative mb-8 md:mt-8">
          ...
          >
            ...
            <span className="block md:hidden text-center text-[32px] leading-tight animate-fly-in-from-bottom">
              ...
              <br />
              <span className="text-notion-dark dark:text-white px-0.5 py-0 font-notion-inter font-bold not-italic">Prepare All Files.</span>
            </span>
            ...
            <span className="hidden lg:block text-left leading-tight animate-fly-in-from-bottom">
              ...
              <br />
              <span className="text-notion-dark dark:text-white py-0 font-notion-inter font-bold not-italic">to Find <span className="text-green-600 dark:text-green-500">Jobs</span> and Prepare All Files.</span>
            </span>
