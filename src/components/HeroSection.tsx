    ...
    <section className="relative min-h-[80vh] flex items-center justify-center px-4 pt-20 sm:pt-24 pb-8 overflow-hidden bg-white dark:bg-black">
      ...
      <div className="max-w-7xl mx-auto z-20 relative w-full">
        ...
        <div className="relative mb-8">
          ...
          <h1 className="relative z-30 text-3xl md:text-4xl lg:text-5xl mb-1 leading-tight font-sans tracking-tight text-foreground drop-shadow-2xl animate-fade-in dark:[text-shadow:_0_0_40px_rgba(255,255,255,0.5)] italic">
            ...
            <div className="block md:hidden lg:block">
              <span className="text-black dark:text-white px-0.5 py-0 font-inter font-bold">We do the boring stuff.</span>
              <br />
              <span className="text-black dark:text-white px-0.5 py-0 mt-2 md:mt-3 inline-block font-inter font-bold">You get the job</span> 🏆
            </div>
            
            {/* Tablet view only */}
            <div className="hidden md:block lg:hidden">
              <span className="text-black dark:text-white px-0.5 py-0 font-bold">We do the</span>
              <br />
              <span className="text-black dark:text-white px-0.5 py-0 mt-2 md:mt-3 inline-block font-bold">boring stuff.</span>
              <br />
              <span className="text-black dark:text-white px-0.5 py-0 mt-2 md:mt-3 inline-block font-bold">You get the job</span> 🏆
            </div>
          </h1>
        </div>
        ...
        <div className="text-foreground mb-8 md:mb-10 lg:mb-12 max-w-2xl mx-auto font-gilroy font-light leading-relaxed md:text-base text-sm dark:[text-shadow:_0_2px_4px_rgba(0,0,0,0.9)] text-left [filter:brightness(1.1)_contrast(1.1)]">
          <p className="mb-8 text-base md:text-lg font-inter font-medium">Our AI Agents will update your <span className="font-bold italic text-primary">Resume</span>, send daily <span className="font-bold italic text-primary">Job Alerts</span>, craft tailored <span className="font-bold italic text-primary">Cover Letters</span>, prepare <span className="font-bold italic text-primary">Interview Kits</span>, check <span className="font-bold italic text-primary">Job fit</span>, give insider <span className="font-bold italic text-primary">Company</span> knowledge, and shares the <span className="font-bold italic text-primary">HRs</span> you should contact. Everything you will ever need, all in one place.</p>
