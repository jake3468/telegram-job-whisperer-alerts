  ...
  return <section className="relative min-h-[60vh] sm:min-h-[70vh] flex flex-col items-center justify-center px-4 pt-20 sm:pt-24 pb-2 overflow-hidden bg-black">
      ...
      <div className="text-center max-w-4xl mx-auto z-20 relative">
        ...
        <div className="relative">
          ...
          <h1 className="relative z-30 text-3xl md:text-5xl lg:text-6xl font-bold mb-1 leading-tight font-quattrocento tracking-tight text-white drop-shadow-2xl animate-fade-in [text-shadow:_0_0_40px_rgba(255,255,255,0.5)]">Your AI shortcut to more <span className="italic">job</span> offers.</h1>
        </div>
