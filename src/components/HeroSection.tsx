      ...
      <div className="max-w-7xl mx-auto z-20 relative w-full">
        ...
        <div className="relative mb-8">
          ...
          <h1 className="relative z-30 text-3xl md:text-4xl lg:text-5xl font-bold mb-1 leading-tight font-sans tracking-tight text-white drop-shadow-2xl animate-fade-in [text-shadow:_0_0_40px_rgba(255,255,255,0.5)] italic">
            ...
            <span className="bg-cyan-400 text-black px-0.5 py-0 md:hidden"> boring stuff.</span>
            <br />
            <span className="bg-cyan-400 text-black px-0.5 py-0 mt-2 md:mt-3 inline-block">
              <span className="hidden md:inline">boring stuff. </span>You get the job
            </span> 🏆
          </h1>
        </div>
