...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="bg-gradient-to-br from-black via-gray-950 to-fuchsia-950 border-r border-fuchsia-400/10 shadow-2xl shadow-fuchsia-600/10 backdrop-blur-2xl rounded-tr-3xl rounded-br-3xl min-w-[220px] max-w-[295px] w-[clamp(220px,20vw,295px)] overflow-x-hidden">
      {/* Logo & Name section: always visible, uses landing-style gradients */}
                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <NavLink
                        to={item.url}
                        className={`flex items-center gap-3 px-3 py-3 mx-2 rounded-xl font-orbitron transition-all duration-300 text-base font-extrabold 
                          ${
                            isCurrentlyActive
                      ...
                      >
                        <item.icon className={`w-6 h-6 flex-shrink-0 ${isCurrentlyActive ? 'text-black dark:text-white' : 'text-fuchsia-200'}`} />
                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <NavLink
                        to={item.url}
                        className={`flex items-center gap-3 px-3 py-3 mx-2 rounded-xl font-orbitron transition-all duration-300 text-base font-bold 
                          ${
                            isCurrentlyActive
