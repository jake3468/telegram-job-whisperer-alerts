...
export function AppSidebar() {
  ...
  return <Sidebar className="
    ...
    ">
      {/* Logo & Name section: hide on mobile/tablet since it's shown in top navbar */}
      {!isMobile && (
        <SidebarHeader className="py-2 px-3 border-b border-fuchsia-400/15 bg-black/95 relative flex flex-col items-center gap-1">
          <img 
            ...
            className="max-h-10 mb-1 drop-shadow-2xl object-fill"
            loading="eager"
      ...
      {/* X button for mobile - positioned differently when header is hidden */}
      {isMobile && (
