    ...
    switch (currentStep) {
      case 0:
        return <div className="text-center space-y-3 sm:space-y-4">
            ...
            <h2 className="text-sm sm:text-lg font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent text-center">Job Tracker - From &quot;Saved&quot; to &quot;You're Hired&quot; </h2>
