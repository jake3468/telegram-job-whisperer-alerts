...
export const PremiumAnalysisResults: React.FC<PremiumAnalysisResultsProps> = ({ analysis }) => {
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 to-white min-h-screen">
      <div className="w-full max-w-5xl mx-auto space-y-3 md:space-y-4 px-1 sm:px-2 py-2 sm:py-3">
        {/* Hero Section */}
        <div className="w-full bg-white rounded-lg md:rounded-xl shadow-sm md:shadow-md border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 p-2 sm:p-3 md:p-4 text-white">
            <div className="flex flex-col gap-2 md:gap-3">
              <div className="space-y-1 md:space-y-2">
                <div className="flex items-start gap-1.5 sm:gap-2">
                  <div className="p-1 md:p-1.5 bg-white/20 rounded-md backdrop-blur-sm flex-shrink-0">
                    <Building2 className="w-3 h-3 md:w-4 md:h-4" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h1 className="text-xs sm:text-sm md:text-base lg:text-lg font-bold break-words leading-tight">
                      {analysis.job_title}
                    </h1>
                    <p className="text-xs md:text-sm text-blue-100 break-words truncate">
                ...
                <div className="flex flex-wrap gap-1 text-xs">
                  <div className="flex items-center gap-1 bg-white/10 px-1.5 py-0.5 md:px-2 md:py-1 rounded-full backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-1.5 sm:gap-2 md:gap-3 mt-2">
                {analysis.role_security_score !== null && (
                  <div className="bg-white/10 backdrop-blur-sm rounded-md md:rounded-lg p-1.5 sm:p-2 md:p-3 text-center">
                    ...
                    <div className="flex justify-center mt-0.5">
                      <Award className="w-2.5 h-2.5 md:w-3 md:h-3 text-yellow-300" />
                    </div>
                  </div>
                )}
                {analysis.role_experience_score !== null && (
                  <div className="bg-white/10 backdrop-blur-sm rounded-md md:rounded-lg p-1.5 sm:p-2 md:p-3 text-center">
                    ...
                    <div className="flex justify-center mt-0.5">
                      <Star className="w-2.5 h-2.5 md:w-3 md:h-3 text-yellow-300" />
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="w-full space-y-3 md:space-y-4">
          ...
          {analysis.local_role_market_context && (
            <div className="group w-full">
              ...
              />
              <Card className="w-full bg-white shadow-sm md:shadow-md border-0 rounded-lg md:rounded-xl overflow-hidden">
                <CardContent className="p-2 sm:p-3 md:p-4">
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-md md:rounded-lg p-2 sm:p-3 md:p-4 border-l-2 border-blue-500">
                    <p className="text-gray-700 leading-relaxed text-xs md:text-sm break-words">
                      {analysis.local_role_market_context}
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="w-full bg-white shadow-sm md:shadow-md border-0 rounded-lg md:rounded-xl overflow-hidden">
                <CardContent className="p-2 sm:p-3 md:p-4 space-y-2 sm:space-y-3 md:space-y-4">
                  ...
                  {analysis.role_security_outlook && (
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-md md:rounded-lg p-2 sm:p-3 md:p-4 border-l-2 border-green-500">
                      <h4 className="font-semibold text-green-800 mb-1 text-xs">Outlook</h4>
                  ...
                  {analysis.role_security_automation_risks && (
                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-md md:rounded-lg p-2 sm:p-3 md:p-4 border-l-2 border-yellow-500">
                      <h4 className="font-semibold text-yellow-800 mb-1 text-xs">Automation Risks</h4>
                      <p className="text-gray-700 leading-relaxed text-xs break-words">
                        {analysis.role_security_automation_risks}
                      </p>
                    </div>
                  ...
                  {analysis.role_security_departmental_trends && (
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-md md:rounded-lg p-2 sm:p-3 md:p-4 border-l-2 border-blue-500">
                      <h4 className="font-semibold text-blue-800 mb-1 text-xs">Departmental Trends</h4>
                      <p className="text-gray-700 leading-relaxed text-xs break-words">
                        {analysis.role_security_departmental_trends}
                      </p>
                    </div>
              ...
              <Card className="w-full bg-white shadow-sm md:shadow-md border-0 rounded-lg md:rounded-xl overflow-hidden">
                <CardContent className="p-2 sm:p-3 md:p-4 space-y-2 sm:space-y-3 md:space-y-4">
                  ...
                  {analysis.role_experience_specific_insights && (
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-md md:rounded-lg p-2 sm:p-3 md:p-4 border-l-2 border-purple-500">
                      <h4 className="font-semibold text-purple-800 mb-1 text-xs">Specific Insights</h4>
                      <p className="text-gray-700 leading-relaxed text-xs break-words">
                        {analysis.role_experience_specific_insights}
                      </p>
                    </div>
