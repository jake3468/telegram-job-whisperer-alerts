...
export const PremiumAnalysisResults: React.FC<PremiumAnalysisResultsProps> = ({ analysis }) => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-white overflow-hidden min-w-0">
      <div className="w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto px-1 sm:px-2 md:px-4 py-2 sm:py-4 space-y-3 sm:space-y-4 min-w-0">
        {/* Hero Section */}
        <div className="w-full min-w-0">
          <div className="w-full bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden min-w-0">
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 p-2 sm:p-3 text-white min-w-0">
              <div className="w-full flex flex-col gap-2 sm:gap-3 min-w-0">
                <div className="w-full space-y-1 sm:space-y-2 min-w-0">
                  <div className="w-full flex items-start gap-2 sm:gap-3 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <h1 className="text-xs sm:text-sm md:text-base font-bold leading-tight break-words hyphens-auto">
                        {analysis.job_title}
                      </h1>
                      <p className="text-xs text-blue-100 mt-1 break-words hyphens-auto">
                        at {analysis.company_name}
                      </p>
                    </div>
                  </div>
                  
                  <div className="w-full flex flex-wrap gap-1 text-xs min-w-0">
                    <div className="flex items-center gap-1 bg-white/10 px-1 sm:px-2 py-1 rounded-full backdrop-blur-sm min-w-0">
                      <MapPin className="w-2 h-2 flex-shrink-0" />
                      <span className="break-words text-xs truncate">{analysis.location}</span>
                    </div>
                    {analysis.research_date && (
                      <div className="flex items-center gap-1 bg-white/10 px-1 sm:px-2 py-1 rounded-full backdrop-blur-sm min-w-0">
                        <Calendar className="w-2 h-2 flex-shrink-0" />
                        <span className="break-words text-xs truncate">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2 min-w-0">
                  {analysis.role_security_score !== null && (
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-1 sm:p-2 text-center min-w-0">
        ...
        <div className="w-full space-y-3 sm:space-y-4 min-w-0">
            ...
            <div className="w-full min-w-0">
              ...
              <Card className="w-full bg-white shadow-lg border-0 rounded-lg overflow-hidden min-w-0">
                <CardContent className="p-2 w-full min-w-0">
                  <div className="w-full bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-2 border-l-4 border-blue-500 min-w-0">
                    <p className="text-gray-700 leading-relaxed text-xs break-words hyphens-auto">
                      {analysis.local_role_market_context}
                    </p>
                  </div>
                </CardContent>
          ...
          {(analysis.role_security_score !== null || analysis.role_security_outlook || analysis.role_security_automation_risks || analysis.role_security_departmental_trends || (analysis.role_security_score_breakdown && analysis.role_security_score_breakdown.length > 0)) && (
            <div className="w-full min-w-0">
              ...
              />
              <Card className="w-full bg-white shadow-lg border-0 rounded-lg overflow-hidden min-w-0">
                <CardContent className="p-2 w-full space-y-2 min-w-0">
                  {analysis.role_security_score !== null && (
                  ...
                  {analysis.role_security_outlook && (
                    <div className="w-full bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-2 border-l-4 border-green-500 min-w-0">
                  ...
                  {analysis.role_security_automation_risks && (
                    <div className="w-full bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-2 border-l-4 border-yellow-500 min-w-0">
                  ...
                  {analysis.role_security_departmental_trends && (
                    <div className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-2 border-l-4 border-blue-500 min-w-0">
              ...
              <Card className="w-full bg-white shadow-lg border-0 rounded-lg overflow-hidden min-w-0">
                <CardContent className="p-2 w-full space-y-2 min-w-0">
                  ...
                  {analysis.role_experience_specific_insights && (
                    <div className="w-full bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-2 border-l-4 border-purple-500 min-w-0">
