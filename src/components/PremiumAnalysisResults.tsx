              ...
              <div className="w-full flex flex-col gap-2 sm:gap-3 min-w-0 overflow-hidden">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2 min-w-0 overflow-hidden">
                  {analysis.role_security_score !== null && (
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-1 sm:p-2 text-center min-w-0 overflow-hidden">
              ...
              <Card className="w-full bg-white shadow-lg border-0 rounded-lg overflow-hidden min-w-0">
                <CardContent className="p-2 w-full space-y-2 min-w-0 overflow-hidden">
                  ...
                  {analysis.role_security_outlook && (
                    <div className="w-full bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-2 border-l-4 border-green-500 min-w-0 overflow-hidden">
                  ...
                  {analysis.role_security_automation_risks && (
                    <div className="w-full bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-2 border-l-4 border-yellow-500 min-w-0 overflow-hidden">
                  ...
                  {analysis.role_security_departmental_trends && (
                    <div className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-2 border-l-4 border-blue-500 min-w-0 overflow-hidden">
              ...
              <Card className="w-full bg-white shadow-lg border-0 rounded-lg overflow-hidden min-w-0">
                <CardContent className="p-2 w-full space-y-2 min-w-0 overflow-hidden">
                  ...
                  {analysis.role_experience_specific_insights && (
                    <div className="w-full bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-2 border-l-4 border-purple-500 min-w-0 overflow-hidden">
