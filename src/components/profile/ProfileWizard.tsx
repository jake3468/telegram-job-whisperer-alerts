...
export const ProfileWizard = () => {
  ...
  return (
    <div className="h-screen w-full max-w-full px-3 py-2 sm:px-4 sm:py-4 sm:max-w-2xl md:max-w-4xl mx-auto overflow-hidden flex flex-col justify-between">
      <div className="flex flex-col flex-1">
        ...
        {/* Step Navigation */}
        <div className="flex flex-row justify-center items-center space-x-1 sm:space-x-2 mb-4 sm:mb-6">
          {[1, 2, 3].map((stepNum) => {
              ...
              <div key={stepNum} className="flex items-center">
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className={`flex flex-col items-center transition-all duration-200 min-h-[32px] sm:min-h-[40px] px-1 py-1 sm:px-2 sm:py-1 ${
                  ...
                  >
                    <div className={`w-6 h-6 sm:w-9 sm:h-9 rounded-full flex items-center justify-center font-bold text-xs sm:text-base mb-1 transition-all duration-200 ${
                      status === 'complete' 
      ...
      <div className="flex justify-between items-center gap-3 flex-shrink-0 pt-4 pb-2">
        <Button
          onClick={prevStep}
          variant="outline"
