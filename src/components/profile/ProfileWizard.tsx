...
export const ProfileWizard = () => {
  ...
  return (
    <div className="w-full max-w-full px-3 py-2 sm:px-4 sm:py-4 sm:max-w-2xl md:max-w-4xl mx-auto overflow-x-hidden flex flex-col h-screen justify-between">
      <div className="flex-1 flex flex-col">
        {/* Welcome Header */}
        <div className="text-center mb-2 sm:mb-4">
          <h1 className="font-extrabold text-lg sm:text-2xl md:text-3xl font-orbitron drop-shadow mb-1 break-words">
          ...
          <p className="text-gray-300 text-sm sm:text-base mt-1 px-2">Let's set up your profile in just 3 steps</p>
        </div>
        ...
        {/* Step Navigation */}
        <div className="flex flex-row justify-center items-center space-x-1 sm:space-x-2 mb-2 sm:mb-4">
          {[1, 2, 3].map((stepNum) => {
              ...
              <div key={stepNum} className="flex items-center">
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className={`flex flex-col items-center transition-all duration-200 min-h-[32px] sm:min-h-[40px] px-1 py-1 sm:px-2 sm:py-2 ${
