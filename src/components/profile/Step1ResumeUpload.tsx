  ...
  return <div className="space-y-2 sm:space-y-4 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 px-2 mb-2">
        ...
        <div className="flex-1">
          ...
          <p className="text-white text-xs sm:text-sm leading-relaxed">Upload your resume so our AI can personalize your experience (PDF format, max 5MB). It does not need to be perfect now, this can be made better later.</p>
        </div>
      </div>
