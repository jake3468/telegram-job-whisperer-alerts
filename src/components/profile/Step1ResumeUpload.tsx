...
export const Step1ResumeUpload = ({
  ...
  return <div className="h-full flex flex-col">
      ...
      {/* Success Message */}
      {resumeExists && <div className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-400/20 rounded-lg p-2 sm:p-3 flex items-center gap-2 backdrop-blur-sm mb-2">
