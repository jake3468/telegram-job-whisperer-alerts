...
const JobAnalysisHistory = ({
  ...
  return <>
      <Button onClick={handleOpenModal} disabled={isLoading} variant="outline" size="sm" className="border-white/20 bg-zinc-50 text-zinc-950">
        {isLoading ? <>
      ...
      <JobAnalysisHistoryModal isOpen={isModalOpen} onClose={() => {
