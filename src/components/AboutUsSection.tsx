const AboutUsSection = () => {
  return <section id="about-us" className="bg-white dark:bg-black py-4 md:py-6 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-3">
          <h2 className="text-3xl md:text-4xl font-semibold text-black dark:text-white mb-2 font-inter transition-colors duration-300">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600 dark:text-gray-400 font-inter font-medium text-xs transition-colors duration-300">
            ...
            {' '}and{' '}
            <a href="/terms-of-service" className="text-black dark:text-white hover:text-gray-500 dark:hover:text-gray-200 underline transition-colors font-semibold">
              Terms of Service
            </a>
            .
          </p>
