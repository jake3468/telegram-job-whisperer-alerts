...
const ToolsSection = () => {
  return <section id="features" className="relative bg-background">
      ...
      <div className="space-y-0">
        ...
        <FeatureSection title="Job Board" subheading="" description="look… scrolling through job sites is exhausting. half the jobs are from 3 weeks ago, the other half don't even match what you do. we just show you jobs from the last 24 hours that actually fit your role and location. that's it. no clutter, no ancient listings, no wasting your time." lottieUrl="https://fnzloyyhzhrqsvslhhri.supabase.co/storage/v1/object/public/animations//alerts%20job.json" buttonText="Set Up Alerts" isReversed={false} />
