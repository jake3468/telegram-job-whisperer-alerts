...
const FAQSection = () => {
  const faqs = [{
    ...
    answer: "We offer a free plan with 10 credits per month to get you started. For users who need more, you only pay as you use our platform - flexible pricing based on your usage with credit packs. All our pricing is transparent with no hidden fees, and we offer refunds within 48 hours if you're not satisfied. Premium users also get priority support."
  }, {
