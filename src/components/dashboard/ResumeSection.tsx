  ...
  return <section className="p-0 rounded-none bg-transparent shadow-none">
      <Card className="
        ...
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-white/90 text-base font-inter font-normal drop-shadow-[0_2px_10px_rgba(80,70,140,0.5)]">Upload your resume (PDF, max 5MB) so our AI can better understand your background and personalize your experience</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 pt-0">
          {resumeUrl ? <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-xl border border-white/20 bg-black/70 shadow-inner">
            ...
            </div> : <div className="border-2 border-dashed border-white/65 rounded-xl p-5 sm:p-8 text-center cursor-pointer hover:border-fuchsia-300 hover:bg-fuchsia-400/10 transition-all duration-300 bg-black/50 shadow-inner" onClick={triggerFileInput}>
