...
const ResumeSection = () => {
  ...
  return <section className="rounded-3xl bg-gradient-to-br from-pastel-blue/90 via-pastel-lavender/80 to-pastel-peach/90 shadow-xl shadow-pastel-lavender/30 p-6 md:p-8">
      <Card className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 border-2 border-blue-400 shadow-2xl shadow-blue-500/20">
        ...
        <CardContent className="space-y-3 pt-0">
          {resumeUrl ? <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg border border-white/20 backdrop-blur-sm gap-3 bg-gray-900">
            ...
            </div> : <div className="border-2 border-dashed border-white/40 rounded-lg p-4 sm:p-6 text-center cursor-pointer hover:border-white/60 hover:bg-white/5 transition-all duration-300 backdrop-blur-sm" onClick={triggerFileInput}>
