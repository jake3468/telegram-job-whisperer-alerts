...
const JobAlertsSection = ({
  ...
  return <section className="rounded-3xl bg-gradient-to-b from-black/90 via-[#16181e]/95 to-[#21223A]/98 border-2 border-emerald-400 shadow-none p-0">
      <div className="pt-4 px-2 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          ...
          {isActivated && !showForm && <div className="flex items-center mt-2 sm:mt-0">
              <Button onClick={handleCreateAlert} className="text-black font-bold px-4 py-2 rounded-lg shadow-sm transition bg-slate-50">
        ...
        />
          ...
          {isActivated && <>
              {showForm && <div className="mb-6">
                  <JobAlertForm userTimezone={userTimezone} editingAlert={editingAlert} onSubmit={handleFormSubmit} onCancel={handleFormCancel} />
                </div>}
