        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-6 md:p-8 lg:p-10">
          ...
          {lottieUrl ? (
            ...
            <div className="lg:hidden text-center space-y-4">
              <h3 className="text-2xl md:text-3xl font-bold font-opensans text-indigo-700">
                {title}
              </h3>
              <p className="font-opensans font-medium text-neutral-950 text-sm">
                {subheading}
              </p>
              <p className="leading-relaxed font-opensans text-neutral-950 text-xs font-normal">
                {description}
              ...
              <div className="flex justify-center pt-2">
                {isComingSoon ? 
                  <button type="button" disabled className="w-fit bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded-full flex items-center gap-2 transition-all duration-200 cursor-not-allowed opacity-75">
                    Coming Soon
                  </button> : 
          ...
          {lottieUrl ? (
            ...
            <div className="hidden lg:block">
              <div className="max-w-4xl mx-auto text-center">
                <h3 className="text-3xl lg:text-4xl font-bold mb-4 font-opensans text-blue-700">
                  {title}
                </h3>
                <p className="text-xl mb-6 font-opensans font-medium text-neutral-950">
                  {subheading}
                </p>
                <p className="text-lg leading-relaxed mb-8 font-opensans font-light text-neutral-950">
                  {description}
                </p>
                <div className="flex justify-center">
                  {isComingSoon ? 
                    <button type="button" disabled className="w-fit bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-full flex items-center gap-2 transition-all duration-200 cursor-not-allowed opacity-75">
                      Coming Soon
                    </button> : 
                    <SignUpButton mode="modal">
                      <button type="button" className="w-fit bg-primary hover:bg-primary/90 text-white font-bold py-3 px-8 rounded-full flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl">
