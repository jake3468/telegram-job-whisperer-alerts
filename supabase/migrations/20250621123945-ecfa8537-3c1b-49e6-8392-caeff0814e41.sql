...
-- Fix the interview prep webhook function to match the working job analysis pattern
...
BEGIN
    ...
    payload := jsonb_build_object(
        ...
        'anti_duplicate_metadata', jsonb_build_object(
            ...
            'trigger_source', 'interview_prep_trigger_v2',
    ...
    -- Make the HTTP POST request to the edge function (simplified like job analysis)
    SELECT * INTO http_response FROM net.http_post(
        ...
        headers := jsonb_build_object(
            ...
            'X-Source', 'interview-prep-trigger-v2',
