...
-- Drop any existing trigger and function first to avoid conflicts
...
-- Create the trigger function that fires on INSERT operations
...
BEGIN
    ...
    RAISE LOG 'Company role analysis webhook trigger started for record ID: %', NEW.id;
    ...
    -- Build the complete payload with basic company info (analysis fields will be null initially)
    payload := jsonb_build_object(
        ...
        'anti_duplicate_metadata', jsonb_build_object(
            ...
            'trigger_source', 'company_analysis_trigger_v5',
    ...
    SELECT * INTO http_response FROM net.http_post(
        ...
        headers := jsonb_build_object(
            ...
            'X-Source', 'company-analysis-trigger-v5',
