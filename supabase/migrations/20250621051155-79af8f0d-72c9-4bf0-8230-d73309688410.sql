...
-- Fix the company role analysis webhook trigger by replacing it with a simple, working implementation
...
-- Create a simple webhook trigger function following the exact pattern of working triggers
