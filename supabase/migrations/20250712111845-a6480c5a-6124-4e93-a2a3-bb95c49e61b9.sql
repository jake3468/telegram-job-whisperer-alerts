...
-- Add payment products for AI Interview packs (using 'credit_pack' as product_type)
...
-- USD Products
('ai_interview_1_usd', 'AI Mock Interview - 1 Call', 'credit_pack', 1, 599, 'USD', 'USD', 'global', true),
('ai_interview_3_usd', 'AI Mock Interview - 3 Calls', 'credit_pack', 3, 1499, 'USD', 'USD', 'global', true),
('ai_interview_5_usd', 'AI Mock Interview - 5 Calls', 'credit_pack', 5, 2299, 'USD', 'USD', 'global', true),
-- INR Products  
('ai_interview_1_inr', 'AI Mock Interview - 1 Call', 'credit_pack', 1, 24900, 'INR', 'INR', 'india', true),
('ai_interview_3_inr', 'AI Mock Interview - 3 Calls', 'credit_pack', 3, 59900, 'INR', 'INR', 'india', true),
('ai_interview_5_inr', 'AI Mock Interview - 5 Calls', 'credit_pack', 5, 89900, 'INR', 'INR', 'india', true);
