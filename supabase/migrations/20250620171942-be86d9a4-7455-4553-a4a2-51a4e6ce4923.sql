...
-- First, let's check the current trigger status and recreate it with better error handling
...
-- Create a more robust trigger function with enhanced debugging
...
BEGIN
    ...
    payload := jsonb_build_object(
        ...
        'anti_duplicate_metadata', jsonb_build_object(
            ...
            'trigger_source', 'company_analysis_trigger_v3',
    ...
    SELECT * INTO http_response FROM net.http_post(
        ...
        headers := jsonb_build_object(
            ...
            'X-Source', 'company-analysis-trigger-v3',
