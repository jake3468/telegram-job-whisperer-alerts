...
-- Drop the existing cover letter trigger and function
...
-- Create a simplified trigger function that only uses job_cover_letters data
...
BEGIN
    ...
    -- Build payload with ONLY job_cover_letters data and basic user info
    payload := jsonb_build_object(
        ...
        'anti_duplicate_metadata', jsonb_build_object(
            ...
            'trigger_source', 'cover_letter_trigger_v5',
    ...
    PERFORM net.http_post(
        ...
        headers := jsonb_build_object(
            ...
            'X-Source', 'cover-letter-trigger-v5',
