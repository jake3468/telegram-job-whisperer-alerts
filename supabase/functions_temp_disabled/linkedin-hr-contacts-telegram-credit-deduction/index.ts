...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Processing LinkedIn HR contacts credit deduction for profile:', user_profile_id)
    ...
    const { data: deductResult, error: deductError } = await supabase
      .rpc('deduct_credits', {
        ...
        p_feature_used: 'linkedin_hr_contacts_telegram',
        p_description: 'LinkedIn HR contacts - telegram'
      })
    ...
    const { data: transactionData } = await supabase
      ...
      .eq('user_id', userId)
      .eq('feature_used', 'linkedin_hr_contacts_telegram')
    ...
    return new Response(
      JSON.stringify({
        success: true,
        message: 'Credits deducted successfully for LinkedIn HR contacts',
        user_profile_id: user_profile_id,
        user_id: userId,
    ...
    console.error('Unexpected error in LinkedIn HR contacts credit deduction:', error)
    return new Response(
      JSON.stringify({ 
