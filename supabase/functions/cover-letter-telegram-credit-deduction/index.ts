...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Processing Telegram cover letter credit deduction for profile:', user_profile_id)
    ...
    const { data: deductResult, error: deductError } = await supabase
      .rpc('deduct_credits', {
        ...
        p_feature_used: 'cover_letter_telegram',
        p_description: 'Cover letter - telegram'
      })
    ...
    const { data: transactionData } = await supabase
      ...
      .eq('user_id', userId)
      .eq('feature_used', 'cover_letter_telegram')
    ...
    return new Response(
      JSON.stringify({
        success: true,
        message: 'Credits deducted successfully for Telegram cover letter',
        user_profile_id: user_profile_id,
        user_id: userId,
    ...
    console.error('Unexpected error in cover letter Telegram credit deduction:', error)
    return new Response(
      JSON.stringify({ 
